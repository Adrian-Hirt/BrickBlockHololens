...
public class HandCollisionDetector : MonoBehaviour
{
    private void OnCollisionEnter(Collision other)
    {
        ...
        {
            if (other.gameObject.name.Contains("Right") && PalmUpHandMenu.instance.editMode == PalmUpHandMenu.EditMode.LeftRightHand)
            {
                build(other);
            }
            else if (PalmUpHandMenu.instance.editMode == PalmUpHandMenu.EditMode.Build)
            {
                build(other);
            }
            else
    ...
    private void build(Collision other)
    {
